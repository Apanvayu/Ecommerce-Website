...
<title>Welcome <?php if($_SESSION['username']) echo $_SESSION['username']  ?></title>
...
<ul class="navbar-nav bg-secondary text-center" style="height:100vh">
        <li class="nav-item bg-info">
          <a class="nav-link text-light" href="#"><h4>Your Profile</a></h4>
        </li>
...
{
    include('../users_area/user_images/edit_account.php');
}
